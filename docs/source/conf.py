# -*- coding: utf-8 -*-
#
# crowd.ed documentation build configuration file, created by
...
if not on_rtd: # Causes RTD to choke during build, so only import locally
